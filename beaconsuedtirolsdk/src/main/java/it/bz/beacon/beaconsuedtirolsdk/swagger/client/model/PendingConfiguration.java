...
public class PendingConfiguration {
  ...
  public boolean equals(Object o) {
    ...
    return (this.eddystoneEid == null ? pendingConfiguration.eddystoneEid == null : this.eddystoneEid.equals(pendingConfiguration.eddystoneEid)) &&
        (this.eddystoneEtlm == null ? pendingConfiguration.eddystoneEtlm == null : this.eddystoneEtlm.equals(pendingConfiguration.eddystoneEtlm)) &&
        (this.eddystoneTlm == null ? pendingConfiguration.eddystoneTlm == null : this.eddystoneTlm.equals(pendingConfiguration.eddystoneTlm)) &&
        (this.eddystoneUid == null ? pendingConfiguration.eddystoneUid == null : this.eddystoneUid.equals(pendingConfiguration.eddystoneUid)) &&
        (this.eddystoneUrl == null ? pendingConfiguration.eddystoneUrl == null : this.eddystoneUrl.equals(pendingConfiguration.eddystoneUrl)) &&
        (this.iBeacon == null ? pendingConfiguration.iBeacon == null : this.iBeacon.equals(pendingConfiguration.iBeacon)) &&
        (this.instanceId == null ? pendingConfiguration.instanceId == null : this.instanceId.equals(pendingConfiguration.instanceId)) &&
        (this.interval == null ? pendingConfiguration.interval == null : this.interval.equals(pendingConfiguration.interval)) &&
        (this.major == null ? pendingConfiguration.major == null : this.major.equals(pendingConfiguration.major)) &&
        (this.minor == null ? pendingConfiguration.minor == null : this.minor.equals(pendingConfiguration.minor)) &&
        (this.namespace == null ? pendingConfiguration.namespace == null : this.namespace.equals(pendingConfiguration.namespace)) &&
        (this.telemetry == null ? pendingConfiguration.telemetry == null : this.telemetry.equals(pendingConfiguration.telemetry)) &&
        (this.txPower == null ? pendingConfiguration.txPower == null : this.txPower.equals(pendingConfiguration.txPower)) &&
        (this.url == null ? pendingConfiguration.url == null : this.url.equals(pendingConfiguration.url)) &&
        (this.uuid == null ? pendingConfiguration.uuid == null : this.uuid.equals(pendingConfiguration.uuid));
  }
